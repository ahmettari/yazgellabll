    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="basvurular.php"><i class="fas fa-file-alt"></i> Başvurular</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="kullanicilar.php"><i class="fas fa-users"></i> Kullanıcılar</a>
                </li>
                <li class="nav-item">

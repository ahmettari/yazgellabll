...
<head>
    ...
    <title>Profilim - Akademik Personel Başvuru Sistemi</title>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="list-group">
                            ...
                            <a href="belgelerim.php" class="list-group-item list-group-item-action">
                                <i class="fas fa-file-alt"></i> Belgelerim
                            </a>
                            <a href="basvurularim.php" class="list-group-item list-group-item-action">
                                <i class="fas fa-clipboard-list"></i> Başvurularım
                            </a>
                        </div>
                    </div>
                </div>
